...
symbol = 'CERN'  # Replace with the stock symbol of your choice
start_date = dt.datetime.now() - dt.timedelta(days=10000)
end_date = dt.datetime.now()
df = yf.download(symbol, start=start_date, end=end_date, interval='1h')


#df = data.read_csv(os.path.join(ETF_DIRECTORY, ETF_NAME.lower() + '.us.txt'), sep=',')
